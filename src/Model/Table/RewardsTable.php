 ...
 * @property \App\Model\Table\UserStickersTable&\Cake\ORM\Association\HasMany $UserStickers
 *
 ...
 * @method \App\Model\Entity\Sticker|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Sticker saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
...
class RewardsTable extends Table {
    ...
    public function validationDefault(Validator $validator) {
        ...
        $validator
            ->requirePresence('no_of_affiliate_required', 'create')
            ->notEmptyString('no_of_affiliate_required');
