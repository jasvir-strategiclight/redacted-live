    ...
    <div class="col-md-2">
        ...
        <ul class="nav text-center flex-column u-nav-v2-1" role="tablist"
            ...
            <li class="nav-item active " id="uploadNewImage">
                <a class="nav-link active show py-5 g-px-70 g-color-gray-dark-v1" data-toggle="tab"
            ...
            <li class="nav-item" id="getGalleryImages">
                <a class="nav-link py-5 g-px-70 g-color-gray-dark-v1" data-toggle="tab" href="#nav-2-1-accordion-default-ver-big-icons--2"
                   role="tab">
