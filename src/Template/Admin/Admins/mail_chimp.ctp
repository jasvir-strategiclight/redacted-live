...
<div class="row" xmlns="http://www.w3.org/1999/html">
    ...
    <div class="col-md-10"><h3>Mail Chimp Settings</h3>
        <div class="row">
            <div class="col-md-12">
...
<script>
    $(function () {
        ...
        function loadListings() {
            ...
            $.ajax({
                url: SITE_URL + 'admin/admins/getMcLists',
                type: "POST",
        ...
        function loadFields() {
            $('#loadListingError').hide();
            $.ajax({
                url: SITE_URL + 'admin/admins/getMcListFields',
                type: "POST",
        ...
        $('#saveMappingBtn').click(function (e) {
            ...
            $.ajax({
                url: SITE_URL + 'admin/admins/saveMapping',
                type: "POST",
