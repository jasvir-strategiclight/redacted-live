...
//$('#myModal').modal('show');
 ...
 $('.reset').click(function (e) {
  ...
  $.ajax({
        type: "GET",
        url: SITE_URL + 'admin/emailTemplates/reset/'+ editBtnId,
        dataType: "json",
        beforeSend: function() {
        // setting a timeout
    ...
    <div id="myModalReset" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Alert</h5>
                ...
                <div class="modal-body">
                    ...
                    <p>Are You sure want to reset this template.</p>
                </div>
                <div class="modal-footer">
