                                            ...
                                            <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                <tbody><tr>
                                                    ...
                                                    <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px; font-family:Arial; font-size: 16px; font-style: normal; font-weight: normal;">
                                                        ...
                                                        <p style="line-height:22px;margin-top:0px;margin-bottom:15px;">Please click the following link to verify that you'd like to get the Redacted Newsletter!  
                                                        
                                                        
                                                        <br> <a href="<?= SITE_URL; ?>users/verify/<?= $token; ?>"><strong>Click Here</strong></a> 
                                                         <p style="line-height:22px;margin-top:0px;margin-bottom:15px;">See you soon!
                                                         <br />Clayton</p>
